...
window.onmessage = function(event) {
    var iframe_id = 'mispay_iframe';
    var mispay_iframe_id = document.getElementById(iframe_id);

    if (mispay_iframe_id) {
        if (event.data === "expired") {
            location.reload();
        } else if (event.data === "shrink") {
            document.getElementById(iframe_id).style.maxHeight = "1200px";
            document.getElementById(iframe_id).style.height = "1000px";
            window.scrollTo(0, document.getElementById(iframe_id).getBoundingClientRect().top + window.pageYOffset - 10);
        } else if (event.data === "fastpay") {
            document.getElementById(iframe_id).style.height = "1100px";
            document.getElementById(iframe_id).style.minHeight = "1100px";
            document.getElementById(iframe_id).style.maxHeight = "1100px";
            window.scrollTo(0, document.getElementById(iframe_id).getBoundingClientRect().top + window.pageYOffset - 10);
        } else if (event.data === "bex") {
            document.getElementById(iframe_id).style.height = "650px";
            document.getElementById(iframe_id).style.minHeight = "650px";
            document.getElementById(iframe_id).style.maxHeight = "650px";
            window.scrollTo(0, document.getElementById(iframe_id).getBoundingClientRect().top + window.pageYOffset - 10);
        } else if (event.data === "bex-cancel") {
            document.getElementById(iframe_id).style.height = "850px";
            document.getElementById(iframe_id).style.minHeight = "850px";
            document.getElementById(iframe_id).style.maxHeight = "3000px";
            window.scrollTo(0, document.getElementById(iframe_id).getBoundingClientRect().top + window.pageYOffset - 10);
            ...
            document.getElementById(iframe_id).style.maxHeight = "inherit";
            document.getElementById(iframe_id).style.minHeight = "500px";
            document.getElementById(iframe_id).style.height = "500px";
            window.scrollTo(0, document.getElementById(iframe_id).getBoundingClientRect().top + window.pageYOffset - 10);
        }
    }
};
...
window.onload = function(event) {
    ...
    if (mispay_iframe_id) {
        document.getElementById(iframe_id).style.minHeight = "600px";
    } else {
        console.log('#' + iframe_id + " iframe bulunamadi!")
    }
};
